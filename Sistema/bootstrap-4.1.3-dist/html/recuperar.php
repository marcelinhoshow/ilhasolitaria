    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="panel-body">
                <form role="form" method="post" action="../src/redefinir.php">
                <fieldset>
                    <input id="usu_email" name="usu_email" placeholder="email@email.com" class="form-control input-md" required="" type="text">
                    <span class="help-block">Insira o email cadastrado no sistema</span>       
                     
                    <button id="recupera" name="recupera" class="btn btn-primary">Recuperar</button>
